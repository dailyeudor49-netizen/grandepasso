  ...
  return (
    <>
      ...
      <style>{`
        ...
        .ty-phone-fix input:focus { border-color: #1B5E6B; box-shadow: 0 0 0 3px rgba(27,94,107,0.1); }
        .ty-phone-fix button {
          padding: 10px 18px; background: #1B5E6B; color: #fff; border: none; border-radius: 8px;
          font-size: 13px; font-weight: 600; cursor: pointer; white-space: nowrap; font-family: 'Inter', sans-serif;
        }
        .ty-phone-fix button:hover { background: #164e5a; }
                ...
                {!showPhoneFix ? (
                  ...
                  <div className="ty-phone-fix">
                    ...
                    <div className="ty-phone-fix-row">
                      ...
                      />
                      <button onClick={handlePhoneUpdate} disabled={phoneSaving}>
