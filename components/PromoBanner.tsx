    ...
    <section className="relative overflow-hidden bg-stone-900">
      <div className="grid lg:grid-cols-2">
        ...
        <div className="relative min-h-[280px] sm:min-h-[400px] lg:min-h-[500px]">
          ...
          <div className="absolute right-4 top-4 rounded-full bg-emerald-600 px-3 py-1.5 text-xs font-bold text-white shadow-lg sm:right-6 sm:top-6 sm:px-4 sm:py-2 sm:text-sm">
            Fino a -50%
          </div>
        </div>
        ...
        <div className="flex items-center bg-stone-900 px-4 py-10 sm:px-8 sm:py-16 lg:px-16">
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-stone-400 sm:mt-6 sm:text-base">
              ...
              per scoprire il comfort Grande Passo Calzature. Un&apos;occasione da non perdere.
            </p>
            <div className="mt-6 flex flex-wrap gap-3 sm:mt-8 sm:gap-4">
              <Link
                href="/catalogo"
                className="inline-flex items-center rounded-full bg-emerald-600 px-6 py-3 text-xs font-bold uppercase tracking-wide text-white transition-all hover:bg-emerald-500 sm:px-8 sm:py-3.5 sm:text-sm"
              >
                Scopri le Offerte
              </Link>
              <Link
