...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Link
      ...
      className="group relative flex flex-col overflow-hidden rounded-xl border-l-2 border-blue-500 bg-white shadow-sm ring-1 ring-stone-200/60 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:ring-indigo-200 sm:rounded-2xl"
    >
      {discount > 0 && (
      ...
      <div className="flex flex-1 flex-col p-3 sm:p-4">
        <p className="text-[8px] font-medium uppercase tracking-wider text-blue-700 sm:text-[10px]">
          {product.subtitle}
        </p>
        ...
        {/* Wellness badge */}
        <div className="mt-1.5 inline-flex w-fit items-center gap-1 rounded-full bg-blue-50 px-2 py-0.5 text-[9px] font-medium text-blue-700 sm:text-[10px]">
