...
function getCarouselImages(): string[] {
  ...
  return fs
    ...
    .map((f) => `/images/land/aureaslide/carosello/${f}`);
}

export const metadata: Metadata = {
  title: "AureaSlide - Sandali Ortopedici per il Benessere dei Tuoi Piedi",
  description:
      ...
      <div className="grid items-start gap-8 md:grid-cols-2 md:gap-12">
        ...
        <div>
          ...
          <h1 className="mb-1 text-2xl font-extrabold tracking-tight text-gray-900 md:text-3xl">
            <span className="text-emerald-700">AureaSlide</span> — Il Sandalo che Attacca Vene Varicose, Caviglie Gonfie e Dolore ai Piedi
          </h1>
    ...
    <section className="expert-section">
      <div className="expert-container">
        <div className="expert-image-col">
          <img
            src="/images/land/aureaslide/farmacista.webp"
            alt="Farmacista certificato ortopedico raccomanda AureaSlide"
        ...
        <div className="expert-text-col">
          ...
          <p className="expert-text">
            ...
            <strong>
              AureaSlide è l&apos;unico sandalo che consiglio perché attiva la pompa venosa plantare, scarica il tallone e non comprime le caviglie gonfie.
            </strong>
          </p>
...
export default function AureaslideLanding() {
  return (
  ...
  return (
    <section className="lp-fasi">
      <div className="lp-fasi-head">
        ...
        <p>Vene varicose, caviglie gonfie, fascite, gambe pesanti, tallonite: AureaSlide è progettato per attaccarli tutti, spiegandoti esattamente perché funziona.</p>
      </div>
      <div className="lp-fasi-grid">
        {[
          { img: "/images/land/aureaslide/card/card1.webp", alt: "Vene Varicose", tag: "Beneficio 1", title: "Vene Varicose: Stop", text: <>Ogni passo attiva la pompa venosa. <strong>Le gambe smettono di bruciare.</strong></> },
          { img: "/images/land/aureaslide/card/card2.webp", alt: "Caviglie Gonfie", tag: "Beneficio 2", title: "Caviglie Gonfie: Liberate", text: <>La fibbia si adatta al gonfiore. <strong>Zero compressione, zero strozzatura.</strong></> },
          { img: "/images/land/aureaslide/card/card3.webp", alt: "Fascite e Tallonite", tag: "Beneficio 3", title: "Fascite e Tallonite: Stop", text: <>Il plantare rosso scarica il tallone. <strong>D&apos;estate non fa più male.</strong></> },
        ].map((f) => (
...
const techCards = [
  { img: "/images/land/aureaslide/card/card1.webp", alt: "Suola Tecnica Ondulata", chip: "Vene Varicose · Circolazione", title: "Suola Tecnica Ondulata", text: <>Attiva la pompa venosa plantare ad ogni passo. <strong>Le vene bruciano meno. Le gambe pesano meno. La circolazione migliora camminando.</strong></> },
  { img: "/images/land/aureaslide/card/card2.webp", alt: "Fibbia Oro Regolabile", chip: "Caviglie Gonfie · Adattabilità", title: "Fibbia Oro Regolabile", text: <>Si adatta al gonfiore variabile della giornata. <strong>Zero compressione sulle caviglie anche nelle ore più calde.</strong></> },
  { img: "/images/land/aureaslide/card/card3.webp", alt: "Plantare Rosso Ammortizzante", chip: "Fascite · Tallonite", title: "Plantare Rosso Ammortizzante", text: <>Alta densità, supporto arco, scarico tallone completo. <strong>La fascite non ha più carburante per farti male d&apos;estate.</strong></> },
  { img: "/images/land/aureaslide/card/card4.webp", alt: "Ammortizzazione Diretta", chip: "Anti-impatto · Passo più morbido", title: "Ammortizzazione Diretta", text: <>Assorbe ogni impatto prima che raggiunga tallone e articolazioni. <strong>Sampietrini, pavimenti duri, spiaggia — nessuna superficie fa più male.</strong></> },
  { img: "/images/land/aureaslide/card/card5.webp", alt: "Profilo Anti-fatica", chip: "Gambe Pesanti · Anti-fatica", title: "Profilo Anti-fatica", text: <>Guida il passo naturalmente riducendo lo sforzo muscolare. <strong>Cammini ore senza sentire quel peso insopportabile di fine giornata.</strong></> },
  { img: "/images/land/aureaslide/card/card6.webp", alt: "Fascia Larga Anti-pressione", chip: "Comfort · Zero Attrito", title: "Fascia Larga Anti-pressione", text: <>Nessuna sfregatura, nessun callo, nessuna vescica. <strong>Indossalo dal mattino alla sera senza conseguenze.</strong></> },
];
