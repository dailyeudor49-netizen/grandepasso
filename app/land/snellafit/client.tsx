...
function HeroBadge() {
  ...
  return (
    <div
      className={`mt-2 max-w-fit rounded-lg bg-pink-500 px-3 py-2 text-center text-xs font-bold text-white transition-opacity duration-300 ${
...
const lpReviewData = [
  { batch: 1, av: "G", name: "Giulia P.", meta: "✓ Verificata · Milano", stars: "★★★★★", text: "Ho perso 2 cm di coscia in 3 settimane senza cambiare nulla nella mia alimentazione. Le indosso tutti i giorni per andare al lavoro. I glutei sono visibilmente più tonici. Il mio fidanzato l'ha notato subito!" },
  { batch: 1, av: "F", name: "Francesca M.", meta: "✓ Verificata · Roma", stars: "★★★★★", text: "Ero scettica ma le ho provate lo stesso. Dopo 2 settimane i pantaloni mi stavano larghi. La cellulite sulle cosce è diminuita tantissimo. Le consiglio a tutte le amiche." },
  { batch: 1, av: "A", name: "Alessia R.", meta: "✓ Verificata · Napoli", stars: "★★★★★", text: "Finalmente una soluzione che funziona senza dover andare in palestra. I glutei sono più alti e sodi, le gambe più snelle. Ho ordinato il secondo paio per mia sorella." },
];
          ...
          <>
            ...
            <form onSubmit={(e) => { e.preventDefault(); setFormSubmitted(true); }}>
              ...
              <div className="lp-rev-field">
                ...
                <textarea id="lp-rv-text" placeholder="Raccontaci la tua esperienza con le SnellaFit..." required />
              </div>
...
const lpFaqData = [
  { q: "Funziona davvero per dimagrire?", a: "Sì. La suola instabile costringe i muscoli a lavorare costantemente per mantenere l'equilibrio. Studi dimostrano che si bruciano fino al 30% di calorie in più ad ogni passo rispetto a una scarpa normale. Camminando 30 minuti al giorno, puoi bruciare fino a 200 calorie extra." },
  { q: "Quanto tempo ci vuole per vedere i risultati?", a: "La maggior parte delle clienti nota i primi risultati già dalla seconda settimana: glutei più tonici, gambe meno gonfie, pantaloni che calzano meglio. Risultati completi in 4-6 settimane di utilizzo quotidiano." },
  { q: "Posso indossarle tutto il giorno?", a: "Assolutamente sì! Sono progettate per essere comode anche dopo 10 ore di utilizzo. La tomaia traspirante e la suola ammortizzata le rendono perfette per lavoro, shopping, passeggiate." },
  ...
  { q: "Come scelgo la taglia?", a: "SnellaFit calza regolare. Se sei tra due taglie, scegli la più grande. Scrivici su WhatsApp se hai dubbi — il cambio taglia è gratuito." },
  { q: "Posso restituirle?", a: "Sì. 30 giorni per provarle. Non vedi risultati? Le rimandi indietro gratis. Senza complicazioni. Soddisfatta o rimborsata." },
];
