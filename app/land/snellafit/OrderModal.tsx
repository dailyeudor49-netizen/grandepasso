...
const COLORS = [
  { id: "rosa", label: "Rosa", hex: "#f5d5d0", border: false },
];
...
export function OrderSection({ image }: { image: string }) {
  ...
  const handleSubmit = async () => {
    ...
    let orderToken = "";
    try {
      const tokenRes = await fetch("/api/order-token?slug=snellafit");
      if (tokenRes.ok) {
    ...
    try {
      ...
      localStorage.setItem("cf_thankyou", JSON.stringify({
        ...
        upsell: upsell ? { name: "Plantare Snellente", price: UPSELL_PRICE.toFixed(2) } : null,
    ...
    try {
      ...
      recordOrder();
      window.location.href = "/land/snellafit/ty";
    } catch (err: unknown) {
    ...
    <>
      ...
      <div className="flex flex-col items-center w-full my-5" id="ordina">
        ...
        >
          ...
          Ordina Ora — Inizia a Dimagrire Camminando
        </button>
              ...
              <div className="px-5 pt-4 pb-5">
                ...
                >
                  ...
                  <div className="w-16 h-16 rounded-lg border border-gray-200 overflow-hidden shrink-0 bg-[#fafafa]">
                    <img src="https://www.otomedical.it/wp-content/uploads/2023/01/plantari-ortopedici.png" alt="Plantare Snellente" className="w-full h-full object-cover" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-bold text-gray-900 mb-px">Aggiungi al tuo ordine</p>
                    <p className="text-[15px] font-semibold text-[#ec4899]">Plantare Snellente</p>
                    <p className="text-[13px] text-gray-400 leading-snug mb-1.5">Potenzia l&apos;effetto dimagrante. Attivazione muscolare extra.</p>
            ...
            {step === 2 && (
              <div className="px-5 pt-4 pb-5">
                ...
                <div className="mb-[18px] flex flex-col gap-2.5">
                  ...
                  {upsell && (
                    <div className="flex gap-3 items-center p-3 bg-[#fafafa] border border-gray-200 rounded-[10px]">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-[13px] font-semibold text-gray-900 leading-tight">Plantare Snellente</p>
                ...
                <div className="border-t border-gray-200 mt-[18px] pt-3.5 mb-4">
                  ...
                  {upsell && (
                    <div className="flex justify-between items-center py-1 text-[13px] text-gray-500">
                      <span>Plantare Snellente</span><span className="font-medium">{fmtPrice(UPSELL_PRICE)}</span>
                    </div>
                  )}
                  <div className="flex justify-between items-center py-1 text-[13px] text-gray-500">
