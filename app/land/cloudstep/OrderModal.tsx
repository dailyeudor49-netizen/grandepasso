...
export function OrderSection({ image }: { image: string }) {
  ...
  const handleSubmit = async () => {
    ...
    let orderToken = "";
    try {
      const tokenRes = await fetch("/api/order-token?slug=cloudstep");
      if (tokenRes.ok) {
    ...
    try {
      ...
      recordOrder();
      window.location.href = "/land/cloudstep/ty";
    } catch (err: unknown) {
              ...
              <div className="px-5 pt-4 pb-5">
                ...
                <div className="mb-3.5">
                  {!showEmail ? (
                    <button
                      ...
                      className="flex items-center gap-1.5 text-[13px] font-semibold text-[#e87a00] bg-transparent border-none cursor-pointer p-0"
                    >
                      <svg viewBox="0 0 24 24" className="w-4 h-4 stroke-[#e87a00] fill-none" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-1">
                        <label className="block text-[13px] font-semibold text-gray-700">Email <span className="text-xs font-normal text-[#b87a00]">(facoltativo)</span></label>
                        <button
                          type="button"
                          onClick={() => { setShowEmail(false); updateForm("email", ""); }}
                          className="flex items-center gap-1 text-[12px] font-semibold text-[#e87a00] bg-transparent border-none cursor-pointer p-0"
                        >
                          <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 stroke-[#e87a00] fill-none" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round">
                            <line x1="5" y1="12" x2="19" y2="12" />
                          </svg>
                          Rimuovi
                        </button>
                ...
                <div className="mb-3.5">
                  {!showNotes ? (
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-1">
                        <label className="block text-[13px] font-semibold text-gray-700">Note per il corriere <span className="text-xs font-normal text-[#b87a00]">(facoltativo)</span></label>
                        <button
                          type="button"
