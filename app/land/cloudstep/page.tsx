...
const HERO_IMAGES = [
  "/images/land/cloudstep/unnamed (9).jpg",
  "/images/land/cloudstep/nero.jpg",
  "/images/land/cloudstep/grigio.jpg",
];
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6 order-2 lg:order-1">
          ...
          <div className="flex items-baseline gap-3">
            <span className="text-4xl font-extrabold text-green-600">&euro;49,90</span>
  ...
  <section className="bg-white py-20 px-4">
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-12">
        {[
          { title: "Espande", desc: "La tomaia in knit elastico e pannelli stretch si espande seguendo il gonfiore naturale del piede.", img: "/images/land/cloudstep/adatta.jpg" },
          { title: "Scarica", desc: "Il Toe-box extra-largo lascia le dita libere anche in presenza di edemi o bendaggi leggeri.", img: "/images/land/cloudstep/materiali.png" },
          { title: "Regola", desc: "Grazie al doppio velcro regoli la calzata millimetricamente tra mattino e sera.", img: "/images/land/cloudstep/strap.jpg" }
        ].map((item, i) => (
...
const TechGrid = () => {
  const items = [
    { title: "Apertura 180° Easy-On", tech: "Zip + Doppio Velcro", desc: "Apri tutto, infili e richiudi. Ideale per chi ha mobilità ridotta o gonfiore variabile.", img: "/images/land/cloudstep/unnamed (2).jpg" },
    { title: "Fit by Circonferenza", tech: "Guida Killer", desc: "Oltre alla lunghezza, ti guidiamo sulla circonferenza di pianta e collo per un fit perfetto.", img: "/images/land/cloudstep/unnamed (6).jpg" },
    { title: "Toe-Box + Extra Depth", tech: "Dita Libere", desc: "Volume interno maggiorato per evitare ogni costrizione, anche con piedi molto gonfi.", img: "/images/land/cloudstep/unnamed (3).jpg" },
    { title: "Seam-Free Zones", tech: "Zero Sfregamento", desc: "Interno senza cuciture nei punti critici (alluce e 5° dito) per prevenire irritazioni.", img: "/images/land/cloudstep/unnamed (5).jpg" },
    { title: "Suola Anti-Fatica", tech: "Grip & Ammortizzo", desc: "Strato ammortizzante che riduce l'impatto e battistrada antiscivolo per massima sicurezza.", img: "/images/land/cloudstep/unnamed.jpg" },
    { title: "Spacer Kit Incluso", tech: "Volume Variabile", desc: "2 spessori inclusi per regolare il volume interno in 10 secondi a seconda del momento della giornata.", img: "/images/land/cloudstep/unnamed (4).jpg" }
  ];
        ...
        <motion.div initial={{ y: 100 }} animate={{ y: 0 }} exit={{ y: 100 }} className="fixed bottom-6 left-4 right-4 z-50 md:hidden">
          <div className="bg-white border-2 border-black rounded-[2rem] p-5 shadow-2xl flex items-center gap-6">
            <div className="flex-1">
              <p className="font-black text-2xl tracking-tighter text-green-600">€49,90</p>
