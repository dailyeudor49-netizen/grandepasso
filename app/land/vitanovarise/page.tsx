...
function getCarouselImages(): string[] {
  ...
  return fs
    ...
    .map((f) => `/images/land/vitanovarise/carosello/${f}`);
}

export const metadata: Metadata = {
  title: "LuxeRise - Scarpe Rialzanti Uomo +7cm Invisibili",
  description:
      ...
      <div className="grid items-start gap-8 md:grid-cols-2 md:gap-12">
        ...
        <div>
          ...
          <h1 className="mb-1 text-2xl font-extrabold tracking-tight text-gray-900 md:text-3xl">
            <span className="text-blue-700">LuxeRise</span> — +7 cm Reali. Sembrano Sneaker Normali. Nessuno Lo Capirà Mai.
          </h1>
    ...
    <section className="expert-section">
      <div className="expert-container">
        <div className="expert-image-col">
          <img
            src="/images/land/vitanovarise/gif2.gif"
            alt="LuxeRise - Scarpa rialzante uomo"
        ...
        <div className="expert-text-col">
          ...
          <p className="expert-text">
            ...
            <strong>
              LuxeRise è l&apos;unica scarpa rialzante che consiglio: il rialzo biomeccanico non forza la colonna, distribuisce il peso in modo naturale. Sei più alto. Stai bene. E non devi spiegarlo a nessuno.
            </strong>
          </p>
...
export default function LuxeRiseLanding() {
  return (
  ...
  return (
    <section className="lp-fasi">
      <div className="lp-fasi-head">
        <h2>Essere Bassi Non Fa Male ai Piedi. Fa Male Dentro. <em>LuxeRise Risolve Entrambi.</em></h2>
      ...
      <div className="lp-fasi-grid">
        {[
          { img: "/images/land/vitanovarise/card/1.png", alt: "+7 cm Invisibili", tag: "Beneficio 1", title: "+7 cm Invisibili. Solo Tuo.", text: <>Nessuno lo vede. Nessuno lo capisce. Tu lo sai. E basta.</> },
          { img: "/images/land/vitanovarise/card/2.png", alt: "Zero Dolore", tag: "Beneficio 2", title: "Cammini Ore. Arrivi Intero.", text: <>Suola ammortizzata, zero pressione sulla schiena. Dal mattino alla sera senza sentirle.</> },
          { img: "/images/land/vitanovasecret/benefici/3.webp", alt: "7 cm Che Cambiano", tag: "Beneficio 3", title: "7 cm Che Cambiano Come Ti Trattano.", text: <>Non è solo altezza. È presenza. È come ti guardano. È come ti senti quando entri in una stanza.</> },
        ].map((f) => (
...
const techCards = [
  { img: "/images/land/vitanovarise/beneficio.png", alt: "Rialzo Integrato Invisibile", chip: "Tacco Invisibile · +7 cm", title: "Rialzo Integrato Invisibile", text: <>7 cm nascosti nella struttura della suola. Dall&apos;esterno: sneaker normale. Dall&apos;interno: il tuo vantaggio segreto. <strong>Nessuno lo vede. Mai.</strong></> },
  { img: "/images/land/vitanovasecret/card/card2.webp", alt: "Suola Ortopedica Ammortizzata", chip: "Zero Dolore · Ammortizzazione", title: "Suola Ortopedica Ammortizzata", text: <>Ogni passo viene assorbito prima che raggiunga le articolazioni. Puoi stare in piedi ore. Non lo senti. <strong>Comfort reale — non marketing.</strong></> },
  { img: "/images/land/vitanovasecret/card/card3.webp", alt: "Scarica il Tallone Completamente", chip: "Tallone · Fascite", title: "Scarica il Tallone Completamente", text: <>Il plantare ad arco alto elimina la pressione dove si accumula di più. <strong>Niente tallonite. Niente fitte al primo passo della mattina. Finisce qui.</strong></> },
  { img: "/images/land/vitanovasecret/card/card4.webp", alt: "Protegge Ginocchia e Schiena", chip: "Ginocchia · Schiena", title: "Protegge Ginocchia e Schiena", text: <>La camera d&apos;aria assorbe ogni impatto prima che raggiunga le articolazioni. <strong>Sei più alto — e il tuo corpo non ne paga il prezzo.</strong></> },
  { img: "/images/land/vitanovasecret/card/card5.webp", alt: "Rialzo Biomeccanico Progressivo", chip: "Postura · Bacino", title: "Rialzo Biomeccanico Progressivo", text: <>Non è un tacco verticale. È un rialzo graduato: il bacino resta in asse, la colonna non compensa. <strong>Cammini naturale. La schiena ringrazia.</strong></> },
  { img: "/images/land/vitanovasecret/card/card6.webp", alt: "Tomaia Morbida Avvolgente", chip: "Comfort · Adattabilità", title: "Tomaia Morbida Avvolgente", text: <>Si forma attorno al tuo piede senza punti di pressione. <strong>Zero attrito, zero vesciche. Perfetta anche per piede largo o alluce valgo.</strong></> },
];
      ...
      <div className="lp-inner">
        ...
        <div className="lp-timeline">
          {[
            ...
            { week: "Settimana 4", pct: "100%", title: "Non Torni Più Indietro", text: <>Le scarpe vecchie sono nel cassetto. LuxeRise è ai tuoi piedi. <strong>Sei più alto, stai bene. Il segreto è solo tuo.</strong></> },
          ].map((s) => (
