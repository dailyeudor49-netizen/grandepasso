...
const lpReviewData = [
  { batch: 1, av: "M", name: "Marco V.", meta: "✓ Verificato · Milano", stars: "★★★★★", text: "Sono 1.72 e ho sempre avuto quel blocco sull'altezza. Con LuxeRise arrivo quasi a 1.80. Al primo appuntamento lei mi ha detto \"sei più alto di quanto pensassi.\" Non sa niente. Io sì." },
  { batch: 1, av: "L", name: "Luca D.", meta: "✓ Verificato · Roma", stars: "★★★★★", text: "Ho provato i rialzi dentro la scarpa — si vedono, scivolano, fanno schifo. Con LuxeRise il rialzo è nella suola, cammini normale, e non lo capisce nessuno. Le ho già ordinate in nero e in bianco." },
...
const lpFaqData = [
  ...
  { q: "Come scelgo la taglia?", a: "LuxeRise calza regolare. Se sei tra due taglie, prendi la più grande. Scrivici su WhatsApp — il cambio taglia è gratuito." },
