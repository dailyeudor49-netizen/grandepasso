...
function getCarouselImages(): string[] {
  ...
  return fs
    ...
    .map((f) => `/images/land/aureaflex/carosello/${f}`);
}

export const metadata: Metadata = {
  title: "AureaFlex - Scarpe Ortopediche per Chi Lavora in Piedi",
  description:
      ...
      <div className="grid items-start gap-8 md:grid-cols-2 md:gap-12">
        ...
        <div>
          ...
          <h1 className="mb-1 text-2xl font-extrabold tracking-tight text-gray-900 md:text-3xl">
            <span className="text-emerald-700">AureaFlex</span> — Lavori in Piedi Tutto il Giorno. Meriti una Scarpa che Regge Quanto Te.
          </h1>
    ...
    <section className="expert-section">
      <div className="expert-container">
        <div className="expert-image-col">
          <img
            src="/images/land/aureaflex/farmacista.jpg"
            alt="Farmacista certificato ortopedico raccomanda AureaFlex"
        ...
        <div className="expert-text-col">
          ...
          <p className="expert-text">
            ...
            <strong>
              AureaFlex è l&apos;unica scarpa che unisce knit elasticizzato e suola cloud: sostiene senza stringere, ammortizza senza appesantire. Per questo la consiglio.
            </strong>
          </p>
...
export default function AureaFlexLanding() {
  return (
  ...
  return (
    <section className="lp-fasi">
      <div className="lp-fasi-head">
        ...
        <p>Turni lunghi, corsie infinite, ore al banco: AureaFlex è progettata per chi non può sedersi.</p>
      </div>
      <div className="lp-fasi-grid">
        {[
          { img: "/images/land/aureaflex/benefici/beneficio1.png", alt: "Turni più leggeri", tag: "Beneficio 1", title: "Turni più leggeri", text: <>La suola cloud assorbe ogni passo. <strong>Arrivi a fine turno coi piedi ancora freschi.</strong></> },
          { img: "/images/land/aureaflex/benefici/beneficio2.png", alt: "Schiena meno rigida", tag: "Beneficio 2", title: "Schiena meno rigida", text: <>Il rialzo biomeccanico raddrizza la postura. <strong>Meno tensione ai lombari, meno dolore a fine giornata.</strong></> },
          { img: "/images/land/aureaflex/benefici/beneficio3.png", alt: "Zero sfregamenti", tag: "Beneficio 3", title: "Zero sfregamenti", text: <>Il knit elasticizzato si adatta senza stringere. <strong>Niente vesciche, niente punti di pressione. Anche con piedi gonfi.</strong></> },
        ].map((f) => (
...
const techCards = [
  { img: "/images/land/aureaflex/card/card1.png", alt: "Suola Cloud Anti-Fatica", chip: "Anti-fatica · Passo morbido", title: "Suola Cloud Anti-Fatica", text: <>Assorbe ogni impatto dal primo all&apos;ultimo passo. <strong>I piedi non sentono le ore che passano.</strong></> },
  { img: "/images/land/aureaflex/card/card2.png", alt: "Knit Elasticizzato", chip: "Adattivo · Zero pressione", title: "Knit Elasticizzato", text: <>Si adatta come una seconda pelle, senza stringere mai. <strong>Ideale anche per piedi gonfi a fine turno.</strong></> },
  { img: "/images/land/aureaflex/card/card3.png", alt: "Plantare Supportivo Estraibile", chip: "Supporto interno · Più comfort", title: "Plantare Supportivo Estraibile", text: <>Sostiene tallone, arco e avampiede. <strong>Distribuisce il peso in modo uniforme per chi sta sempre in piedi.</strong></> },
  { img: "/images/land/aureaflex/card/card4.png", alt: "Suola Antiscivolo", chip: "Sicurezza · Grip totale", title: "Suola Antiscivolo", text: <>Grip su pavimenti lisci, bagnati, ospedalieri. <strong>Passo sicuro in ogni ambiente di lavoro.</strong></> },
  { img: "/images/land/aureaflex/card/card5.png", alt: "Rialzo Biomeccanico", chip: "Lombare · Postura", title: "Rialzo Biomeccanico", text: <>Il cuneo posteriore riallinea il bacino ad ogni passo. <strong>La colonna smette di compensare. La schiena ringrazia.</strong></> },
  { img: "/images/land/aureaflex/card/card6.png", alt: "Leggerezza Estrema", chip: "Solo 280g · Ultra-leggera", title: "Leggerezza Estrema", text: <>Solo 280g per piede. <strong>Cammini chilometri senza sentirti appesantita.</strong></> },
];
      ...
      <div className="lp-inner">
        ...
        <div className="lp-timeline">
          {[
            ...
            { week: "Settimana 4", pct: "100%", title: "Nuovo standard", text: <>AureaFlex diventa la tua scarpa da lavoro. <strong>Non torni più indietro.</strong></> },
          ].map((s) => (
