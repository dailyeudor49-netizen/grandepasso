...
const lpReviewData = [
  { batch: 1, av: "L", name: "Laura M.", meta: "✓ Verificata · Milano · Infermiera", stars: "★★★★★", text: "12 ore in corsia ogni giorno. Con le AureaFlex arrivo a fine turno senza avere i piedi distrutti. Le colleghe me le chiedono tutte." },
  ...
  { batch: 1, av: "G", name: "Giulia P.", meta: "✓ Verificata · Napoli · Insegnante", stars: "★★★★★", text: "Stare 5 ore in piedi in classe mi uccideva la schiena. Dopo una settimana con AureaFlex noto già la differenza. Le consiglio a tutte le colleghe." },
  { batch: 2, av: "A", name: "Anna B.", meta: "✓ Verificata · Bologna · OSS", stars: "★★★★★", text: "Turni da 10 ore in RSA. Prima tornavo a casa coi piedi gonfi e doloranti. Ora no. Le AureaFlex mi hanno cambiato la vita lavorativa." },
  ...
  { batch: 3, av: "R", name: "Rosa T.", meta: "✓ Verificata · Bari · Estetista", stars: "★★★★★", text: "Lavoro in piedi tutto il giorno con clienti. Le AureaFlex sono comode, eleganti e professionali. Le mie clienti me le chiedono sempre." },
          ...
          <>
            ...
            <form onSubmit={(e) => { e.preventDefault(); setFormSubmitted(true); }}>
              ...
              <div className="lp-rev-field">
                ...
                <textarea id="lp-rv-text" placeholder="Raccontaci la tua esperienza con le AureaFlex..." required />
              </div>
...
const lpFaqData = [
  ...
  { q: "Come scelgo la taglia giusta?", a: "AureaFlex calza regolare. Se sei tra due taglie, scegli la più grande. Scrivici su WhatsApp se hai dubbi." },
