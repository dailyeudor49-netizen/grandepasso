...
function getCarouselImages(): string[] {
  ...
  return fs
    ...
    .map((f) => `/images/land/aureasecret/carosello/${f}`);
}

export const metadata: Metadata = {
  title: "AureaSecret - Scarpe Rialzanti Ortopediche +7cm Invisibili",
  description:
      ...
      <div className="grid items-start gap-8 md:grid-cols-2 md:gap-12">
        ...
        <div>
          ...
          <h1 className="mb-1 text-2xl font-extrabold tracking-tight text-gray-900 md:text-3xl">
            <span className="text-emerald-700">AureaSecret</span> — 7 cm in Più. Zero Dolore. Nessuno Lo Saprà Mai.
          </h1>
    ...
    <section className="expert-section">
      <div className="expert-container">
        <div className="expert-image-col">
          <img
            src="/images/land/aureasecret/gif.gif"
            alt="AureaSecret - Scarpa rialzante ortopedica"
        ...
        <div className="expert-text-col">
          ...
          <p className="expert-text">
            ...
            <strong>
              AureaSecret è l&apos;unica scarpa rialzante che consiglio: il rialzo progressivo non sovraccarica il tallone, e la suola ortopedica ammortizza ogni impatto. Puoi essere alta e stare bene. Non devi più scegliere.
            </strong>
          </p>
...
export default function AureaSecretLanding() {
  return (
...
const techCards = [
  { img: "/images/land/aureasecret/card/card1.webp", alt: "Rialzo Integrato Invisibile", chip: "Tacco Invisibile · +7 cm", title: "Rialzo Integrato Invisibile", text: <>7 cm nascosti nella struttura della suola. Dall&apos;esterno sembra una sneaker. <strong>Il tuo segreto non si vede mai.</strong></> },
  { img: "/images/land/aureasecret/card/card2.webp", alt: "Suola Ortopedica Ammortizzata", chip: "Zero Dolore · Ammortizzazione", title: "Suola Ortopedica Ammortizzata", text: <>Distribuisce il peso su tutto il piede. La fitta da tacchi non arriva mai. <strong>Comfort reale — non marketing.</strong></> },
  { img: "/images/land/aureasecret/card/card3.webp", alt: "Scarica il Tallone Completamente", chip: "Tallone · Fascite", title: "Scarica il Tallone Completamente", text: <>Il plantare ad arco alto elimina la pressione sul tallone. <strong>Addio tallonite da tacchi. Per sempre.</strong></> },
  { img: "/images/land/aureasecret/card/card4.webp", alt: "Protegge Ginocchia e Schiena", chip: "Ginocchia · Schiena", title: "Protegge Ginocchia e Schiena", text: <>La camera d&apos;aria assorbe ogni impatto prima che raggiunga le articolazioni. <strong>Meno colpi = meno infiammazione = meno dolore.</strong></> },
  { img: "/images/land/aureasecret/card/card5.webp", alt: "Rialzo Biomeccanico Progressivo", chip: "Postura · Bacino", title: "Rialzo Biomeccanico Progressivo", text: <>Il rialzo è graduato — non un tacco verticale. Il bacino rimane in asse. <strong>La colonna non compensa. La schiena ringrazia.</strong></> },
  { img: "/images/land/aureasecret/card/card6.webp", alt: "Tomaia Morbida Avvolgente", chip: "Comfort · Adattabilità", title: "Tomaia Morbida Avvolgente", text: <>Si adatta alla forma del tuo piede senza punti di pressione. <strong>Zero attrito, zero vesciche. Perfetta anche per alluce valgo.</strong></> },
];
    ...
    <section className="lp-sec lp-sec-light" style={{ background: "#f0fdf4" }}>
      <div className="lp-inner">
        ...
        <div className="lp-timeline">
          {[
            { week: "Settimana 1", pct: "25%", title: "Il Primo Giorno Senza Dolore", text: <>Indossi AureaSecret. Sei più alta di 7 cm. Arrivi a casa senza i piedi a pezzi. <strong>Per la prima volta in anni.</strong></> },
            ...
            { week: "Settimana 4", pct: "100%", title: "Non Torni Più Indietro", text: <>I tacchi sono nel cassetto. AureaSecret è sulle tue scarpe. <strong>Sei alta, sei comoda, il segreto è tuo. Come doveva essere sempre.</strong></> },
          ].map((s) => (
