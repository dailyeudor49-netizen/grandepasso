...
const lpReviewData = [
  { batch: 1, av: "V", name: "Valentina R.", meta: "✓ Verificata · Milano", stars: "★★★★★", text: "Sono alta 1.58 e ho passato 10 anni tra tacchi dolorosi e scarpe piatte. Con AureaSecret arrivo a 1.65 e torno a casa senza i piedi distrutti. Al lavoro mi trattano diversamente. Nessuna ha ancora capito come faccio." },
  { batch: 1, av: "S", name: "Sara M.", meta: "✓ Verificata · Roma", stars: "★★★★★", text: "Ho buttato tutti i tacchi. Con i tacchi alle 15:00 avevo già le vesciche e la schiena a pezzi. Con AureaSecret ho gli stessi centimetri ma arrivo a fine giornata intera. Nessuno ha mai sospettato nulla." },
  { batch: 1, av: "C", name: "Chiara T.", meta: "✓ Verificata · Napoli", stars: "★★★★★", text: "Ho la fascite plantare da anni e i tacchi erano diventati impossibili. Con AureaSecret ho i centimetri in più senza infiammare niente. Ho già ordinato il secondo paio in beige." },
];
...
const lpFaqData = [
  ...
  { q: "Come scelgo la taglia?", a: "AureaSecret calza regolare. Se sei tra due taglie, scegli la più grande. Scrivici su WhatsApp se hai dubbi — il cambio taglia è gratuito." },
