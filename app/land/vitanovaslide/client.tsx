...
const lpReviewData = [
  { batch: 1, av: "G", name: "Giuseppina M.", meta: "✓ Verificata · Palermo", stars: "★★★★★", text: "Soffro di vene varicose da anni e d'estate era un calvario. Con LuxeSlide le gambe sono molto più leggere già dopo pochi giorni. Le caviglie non si gonfiano più come prima. Finalmente un sandalo che funziona davvero!" },
  ...
  { batch: 1, av: "C", name: "Carmela F.", meta: "✓ Verificata · Napoli", stars: "★★★★★", text: "Le mie caviglie si gonfiavano ogni pomeriggio. Da quando indosso LuxeSlide il gonfiore è quasi sparito. La fibbia si regola benissimo anche nei giorni peggiori. Non li toglierò mai più!" },
          ...
          <>
            ...
            <form onSubmit={(e) => { e.preventDefault(); setFormSubmitted(true); }}>
              ...
              <div className="lp-rev-field">
                ...
                <textarea id="lp-rv-text" placeholder="Raccontaci la tua esperienza con LuxeSlide..." required />
              </div>
...
const lpFaqData = [
  ...
  { q: "Come scelgo la taglia giusta?", a: "LuxeSlide calza regolare. Se sei tra due taglie scegli la più grande. Scrivici su WhatsApp dopo l'ordine se hai dubbi." },
