...
const PRODUCT_TITLE = "LuxeStep Pro";
...
const SIZE_TO_FULLSHIP: Record<string, number> = {
  "36": 5902, "37": 5903, "38": 5904, "39": 5905,
  "40": 5906, "41": 5907, "42": 5908, "43": 5909, "44": 5910, "45": 5911,
};
...
export function OrderSection({ image }: { image: string }) {
  ...
  const handleSubmit = async () => {
    ...
    let orderToken = "";
    try {
      const tokenRes = await fetch("/api/order-token?slug=vitanovaslide");
      if (tokenRes.ok) {
