...
const lpReviewData = [
  { batch: 1, av: "V", name: "Valentina R.", meta: "✓ Verificata · Milano", stars: "★★★★★", text: "Sono alta 1.58 e ho passato 10 anni tra tacchi dolorosi e scarpe piatte. Con LuxeSecret arrivo a 1.65 e torno a casa senza i piedi distrutti. Al lavoro mi trattano diversamente. Nessuna ha ancora capito come faccio." },
  { batch: 1, av: "S", name: "Sara M.", meta: "✓ Verificata · Roma", stars: "★★★★★", text: "Ho buttato tutti i tacchi. Con i tacchi alle 15:00 avevo già le vesciche e la schiena a pezzi. Con LuxeSecret ho gli stessi centimetri ma arrivo a fine giornata intera. Nessuno ha mai sospettato nulla." },
  { batch: 1, av: "C", name: "Chiara T.", meta: "✓ Verificata · Napoli", stars: "★★★★★", text: "Ho la fascite plantare da anni e i tacchi erano diventati impossibili. Con LuxeSecret ho i centimetri in più senza infiammare niente. Ho già ordinato il secondo paio in beige." },
];
          ...
          <>
            ...
            <form onSubmit={(e) => { e.preventDefault(); setFormSubmitted(true); }}>
              ...
              <div className="lp-rev-field">
                ...
                <textarea id="lp-rv-text" placeholder="Raccontaci la tua esperienza con le LuxeSecret..." required />
              </div>
...
const lpFaqData = [
  { q: "Si vede che sono rialzanti?", a: "Assolutamente no. Il rialzo di 7 cm è completamente integrato nella struttura della suola. Dall'esterno sono una sneaker sportiva normale. Il design è studiato per non tradire mai il segreto." },
  { q: "Fanno male dopo ore in piedi?", a: "No — ed è esattamente il motivo per cui esistono. La suola ortopedica distribuisce il peso su tutto il piede, non su un punto solo come i tacchi normali. Molte clienti le usano 8-10 ore al giorno senza problemi." },
  { q: "Quanto sono reali i 7 cm?", a: "7 cm reali, integrati in modo progressivo nella suola per garantire una camminata naturale e stabile. Non è un tacco verticale: il peso si distribuisce su tutto il piede." },
  ...
  { q: "Come scelgo la taglia?", a: "LuxeSecret calza regolare. Se sei tra due taglie, scegli la più grande. Scrivici su WhatsApp se hai dubbi — il cambio taglia è gratuito." },
