...
const PRODUCT_TITLE = "LuxeSecret";
...
const COLORS = [
  ...
  { id: "nero-tabacco", label: "Nero/Tabacco", hex: "#3d2b1f" },
  { id: "rosa-nude", label: "Rosa Nude", hex: "#e8c4b8" },
];
...
export function OrderSection({ image }: { image: string }) {
  ...
  const handleSubmit = async () => {
    ...
    let orderToken = "";
    try {
      const tokenRes = await fetch("/api/order-token?slug=vitanovasecret");
      if (tokenRes.ok) {
