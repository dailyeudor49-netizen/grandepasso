...
function getCarouselImages(): string[] {
  ...
  return fs
    ...
    .map((f) => `/images/land/vitanovastep/carosello/${f}`);
}

export const metadata: Metadata = {
  title: "LuxeStep Pro - Scarpe Ortopediche per il Benessere dei Tuoi Piedi",
  description:
      ...
      <div className="grid items-start gap-8 md:grid-cols-2 md:gap-12">
        ...
        <div>
          ...
          <h1 className="mb-1 text-2xl font-extrabold tracking-tight text-gray-900 md:text-3xl">
            <span className="text-blue-700">VitaNovaStep</span> — La Scarpa che Attacca il Dolore dove Nasce
          </h1>
          <p className="mb-4 text-base font-medium text-gray-500">
            Fascite plantare, mal di schiena, ginocchia e artrosi: suola rialzante ammortizzante che elimina il dolore ad ogni passo.
          </p>
          ...
          <ul className="mb-6 space-y-2.5">
            {[
              { bold: "Fascite plantare", rest: "il tallone non tocca più duro, la fitta al mattino sparisce" },
              { bold: "Ginocchia e artrosi", rest: "la camera d'aria assorbe ogni impatto prima che distrugga l'articolazione" },
              { bold: "Mal di schiena lombare", rest: "il rialzo biomeccanico riallinea il bacino e scarica la colonna" },
              { bold: "Gambe pesanti", rest: "rullata guidata che dimezza la fatica muscolare" },
              { bold: "Ammortizzazione premium", rest: "cammina ore senza sentire il peso delle ore" },
              { bold: "Traspirante e leggera", rest: "piedi freschi e asciutti tutto il giorno" },
    ...
    <section className="expert-section">
      <div className="expert-container">
        <div className="expert-image-col">
          <img
            src="/images/land/vitanovastep/farmacista.png"
            alt="Farmacista certificato ortopedico raccomanda VitaNovaStep"
        ...
        <div className="expert-text-col">
          ...
          <h2 className="expert-title">
            &ldquo;È la scarpa ortopedica che consiglio ai miei clienti con fascite, artrosi e mal di schiena.&rdquo;
          </h2>
          <p className="expert-attribution">
            Dott. Marco Ferretti — Farmacista specializzato in benessere plantare
          </p>
          <p className="expert-text">
            Ogni giorno in farmacia vedo persone che convivono con dolori che potrebbero risolvere.{" "}
            <strong>
              La VitaNovaStep è l&apos;unica scarpa rialzante ammortizzante che consiglio perché agisce sulla causa meccanica del dolore, non sul sintomo.
            </strong>
          </p>
...
export default function VitaNovaStepLanding() {
  return (
  ...
  return (
    <section className="lp-fasi">
      <div className="lp-fasi-head">
        <h2>Il Dolore Non È Normale. <em>È Risolvibile.</em></h2>
        <p>Fascite, artrosi, schiena, ginocchia: VitaNovaStep è progettata per attaccarli tutti, spiegandoti esattamente perché funziona.</p>
      </div>
      <div className="lp-fasi-grid">
        {[
          { img: "/images/land/vitanovastep/ammortizzazione.webp", alt: "Fascite e Tallonite", tag: "Beneficio 1", title: "Fascite e Tallonite: Stop", text: <>Il plantare ad arco alto scarica il tallone completamente. <strong>La fitta al mattino sparisce perché eliminiamo la causa, non il sintomo.</strong></> },
          { img: "/images/land/vitanovastep/piede-piatto.webp", alt: "Ginocchia e Artrosi", tag: "Beneficio 2", title: "Ginocchia e Artrosi: Protette", text: <>La camera d&apos;aria assorbe l&apos;impatto prima che raggiunga l&apos;articolazione. <strong>Meno colpi = meno infiammazione = meno dolore.</strong></> },
          { img: "/images/land/vitanovastep/schiena.png", alt: "Schiena e Postura", tag: "Beneficio 3", title: "Schiena e Postura: Riallineate", text: <>Il cuneo rialzante riporta il bacino in asse neutro. <strong>La tensione lombare cronica si scioglie perché la causa meccanica viene rimossa.</strong></> },
        ].map((f) => (
      ...
      <div className="lp-inner">
        <div className="lp-stats">
          <div>
            ...
            <div className="lp-stat-l">Riduzione dolore<br />in 7 giorni*</div>
          </div>
          <div>
            <div className="lp-stat-n">47K+</div>
            <div className="lp-stat-l">Clienti soddisfatti<br />in Italia</div>
          </div>
          <div>
...
const techCards = [
  { img: "/images/land/vitanovastep/card1.png", alt: "Scarica il Tallone", chip: "Fascite · Tallonite", title: "Scarica il Tallone. Azzeralo.", text: <>Il plantare ad arco alto elimina la pressione sul legamento plantare. <strong>La fascite non ha più carburante per farti male.</strong></> },
  { img: "/images/land/vitanovastep/card2.png", alt: "Stabilità ad Ogni Passo", chip: "Passo stabile · Più controllo", title: "Stabilità ad Ogni Passo", text: <>La suola accompagna il passo e protegge le ginocchia dal cedimento laterale. <strong>Meno instabilità, meno usura articolare.</strong></> },
  { img: "/images/land/vitanovastep/card3.png", alt: "Plantare Supportivo Estraibile", chip: "Supporto interno · Più comfort", title: "Plantare Supportivo Estraibile", text: <>Sostiene tallone, arco e avampiede. <strong>Funziona anche con il tuo plantare personalizzato.</strong></> },
  { img: "/images/land/vitanovastep/card4.png", alt: "Camera d'Aria Ammortizzante", chip: "Anti-impatto · Passo più morbido", title: "Camera d'Aria Ammortizzante", text: <>Assorbe l&apos;onda d&apos;urto prima che raggiunga ginocchio e anca. <strong>Ogni passo che fai non distrugge più le articolazioni.</strong></> },
  { img: "/images/land/vitanovastep/card5.png", alt: "Rialzo Biomeccanico", chip: "Lombare · Postura", title: "Rialzo Biomeccanico", text: <>Il cuneo posteriore riallinea il bacino ad ogni passo. <strong>La colonna smette di compensare. Il dolore lombare diminuisce.</strong></> },
  { img: "/images/land/vitanovastep/card6.png", alt: "Tomaia Morbida e Avvolgente", chip: "Comfort · Zero Attrito", title: "Tomaia Morbida e Avvolgente", text: <>Il materiale si adatta alla forma del tuo piede senza punti di pressione. <strong>Nessun attrito, nessun dolore. Perfetta anche per alluce valgo e piedi sensibili.</strong></> },
];
    ...
    <section className="lp-sec lp-sec-light" style={{ background: "#f0fdf4" }}>
      <div className="lp-inner">
        ...
        <div className="lp-timeline">
          {[
            { week: "Settimana 1", pct: "25%", title: "Il primo sollievo", text: <>Il tallone tocca terra diversamente. <strong>La fitta al mattino si attenua.</strong> Le ginocchia sentono già meno colpi.</> },
            { week: "Settimana 2", pct: "50%", title: "Il dolore cede", text: <>La schiena è meno tesa. Stai in piedi più a lungo. <strong>Le ginocchia scricchiolano meno. Dormi meglio.</strong></> },
            { week: "Settimana 3", pct: "75%", title: "Torni a muoverti", text: <>Fai le scale, esci, cammini. <strong>Senza pianificare attorno al dolore.</strong></> },
            { week: "Settimana 4", pct: "100%", title: "Non ci pensi più", text: <>Cammini e basta. Come una volta. <strong>Come dovrebbe essere sempre stato.</strong></> },
          ].map((s) => (
