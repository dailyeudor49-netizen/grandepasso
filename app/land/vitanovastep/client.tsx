...
const lpReviewData = [
  { batch: 1, av: "M", name: "Marco G.", meta: "✓ Verificata · Napoli", stars: "★★★★★", text: "Lavoro 12 ore in piedi come cuoco. Prima tornavo a casa che non camminavo più dal dolore. Con le VitaNovaStep mi sento un ragazzino! Le ginocchia non scricchiolano più." },
  ...
  { batch: 1, av: "R", name: "Roberto F.", meta: "✓ Verificata · Milano", stars: "★★★★★", text: "Il dottore voleva operarmi alle ginocchia per l'artrosi. Dopo 1 mese con VitaNovaStep ho annullato l'operazione! Il dolore è quasi sparito." },
          ...
          <>
            ...
            <form onSubmit={(e) => { e.preventDefault(); setFormSubmitted(true); }}>
              ...
              <div className="lp-rev-field">
                ...
                <textarea id="lp-rv-text" placeholder="Raccontaci la tua esperienza con le VitaNovaStep..." required />
              </div>
...
const lpFaqData = [
  ...
  { q: "Come scelgo la taglia giusta?", a: "VitaNovaStep calza regolare. Se sei tra due taglie, scegli la più grande. Scrivici su WhatsApp se hai dubbi." },
