    ...
    <div className="md:sticky md:top-24">
      ...
      <div className="relative aspect-square overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
        <img
          key={active}
          src={images[active]}
          alt={`AureaStep Pro - Foto ${active + 1}`}
...
const lpReviewData = [
  { batch: 1, av: "M", name: "Marco G.", meta: "✓ Verificata · Napoli", stars: "★★★★★", text: "Lavoro 12 ore in piedi come cuoco. Prima tornavo a casa che non camminavo più dal dolore. Con le AureaStep mi sento un ragazzino! Le ginocchia non scricchiolano più." },
  { batch: 1, av: "E", name: "Elena V.", meta: "✓ Verificata · Roma", stars: "★★★★★", text: "Avevo l'alluce valgo da 15 anni e dolori terribili. Queste scarpe mi hanno risolto tutto in 2 settimane. PIANGO dalla felicità! Le consiglio a tutti." },
  { batch: 1, av: "R", name: "Roberto F.", meta: "✓ Verificata · Milano", stars: "★★★★★", text: "Il dottore voleva operarmi alle ginocchia per l'artrosi. Dopo 1 mese con AureaStep ho annullato l'operazione! Il dolore è quasi sparito." },
          ...
          <>
            ...
            <form onSubmit={(e) => { e.preventDefault(); setFormSubmitted(true); }}>
              ...
              <div className="lp-rev-field">
                ...
                <textarea id="lp-rv-text" placeholder="Raccontaci la tua esperienza con le AureaStep..." required />
              </div>
...
const lpFaqData = [
  ...
  { q: "Come scelgo la taglia giusta?", a: "AureaStep calza regolare. Se sei tra due taglie, scegli la più grande. Scrivici su WhatsApp se hai dubbi." },
  { q: "Funzionano per fascite e tallonite?", a: "Sì. Il plantare ad arco alto scarica il tallone e distribuisce il peso su tutta la pianta. La maggior parte dei clienti con fascite sente la differenza già nelle prime 48-72 ore." },
  { q: "Aiutano con l'artrosi al ginocchio?", a: "Sì. La camera d'aria assorbe l'impatto prima che raggiunga l'articolazione. Meno colpi al giorno = meno infiammazione = meno dolore. Molti clienti con artrosi riferiscono miglioramenti già dalla seconda settimana." },
  { q: "Funzionano per il mal di schiena lombare?", a: "Sì. Il rialzo biomeccanico riequilibra il bacino ad ogni passo. Quando il bacino è in asse, la colonna non deve più compensare. Il dolore lombare si riduce strutturalmente." },
  { q: "Posso usarle tutto il giorno?", a: "Sì, sono progettate per uso quotidiano prolungato. Se non hai mai usato una suola rialzante, inizia gradualmente nei primi 2-3 giorni." },
  { q: "Posso usare il mio plantare personalizzato?", a: "Sì, la soletta è estraibile. Sostituiscila con il tuo plantare personalizzato senza problemi." },
];
