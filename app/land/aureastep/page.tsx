...
function getCarouselImages(): string[] {
  const dir = path.join(process.cwd(), "public/images/land/aureastep/carosello");
  if (!fs.existsSync(dir)) return [];
  return fs
    .readdirSync(dir)
    .filter((f) => /\.(webp|jpg|jpeg|png|avif)$/i.test(f))
    .sort((a, b) => parseInt(a) - parseInt(b))
    .map((f) => `/images/land/aureastep/carosello/${f}`);
}
      ...
      <div className="grid items-start gap-8 md:grid-cols-2 md:gap-12">
        ...
        <div>
          ...
          <h1 className="mb-1 text-2xl font-extrabold tracking-tight text-gray-900 md:text-3xl">
            <span className="text-emerald-700">AureaStep</span> — La Scarpa che Attacca il Dolore dove Nasce
          </h1>
    ...
    <section className="expert-section">
      <div className="expert-container">
        <div className="expert-image-col">
          <img
            src="/images/land/aureastep/farmacista.png"
            alt="Farmacista certificato ortopedico raccomanda AureaStep"
        ...
        <div className="expert-text-col">
          ...
          <p className="expert-text">
            ...
            <strong>
              La AureaStep è l&apos;unica scarpa rialzante ammortizzante che consiglio perché agisce sulla causa meccanica del dolore, non sul sintomo.
            </strong>
          </p>
...
export default function AureaStepLanding() {
  return (
  ...
  return (
    <section className="lp-fasi">
      <div className="lp-fasi-head">
        ...
        <p>Fascite, artrosi, schiena, ginocchia: AureaStep è progettata per attaccarli tutti, spiegandoti esattamente perché funziona.</p>
      </div>
      <div className="lp-fasi-grid">
        {[
          { img: "/images/land/aureastep/ammortizzazione.webp", alt: "Fascite e Tallonite", tag: "Beneficio 1", title: "Fascite e Tallonite: Stop", text: <>Il plantare ad arco alto scarica il tallone completamente. <strong>La fitta al mattino sparisce perché eliminiamo la causa, non il sintomo.</strong></> },
          { img: "/images/land/aureastep/piede-piatto.webp", alt: "Ginocchia e Artrosi", tag: "Beneficio 2", title: "Ginocchia e Artrosi: Protette", text: <>La camera d&apos;aria assorbe l&apos;impatto prima che raggiunga l&apos;articolazione. <strong>Meno colpi = meno infiammazione = meno dolore.</strong></> },
          { img: "/images/land/aureastep/schiena.png", alt: "Schiena e Postura", tag: "Beneficio 3", title: "Schiena e Postura: Riallineate", text: <>Il cuneo rialzante riporta il bacino in asse neutro. <strong>La tensione lombare cronica si scioglie perché la causa meccanica viene rimossa.</strong></> },
        ].map((f) => (
...
const techCards = [
  { img: "/images/land/aureastep/card1.png", alt: "Scarica il Tallone", chip: "Fascite · Tallonite", title: "Scarica il Tallone. Azzeralo.", text: <>Il plantare ad arco alto elimina la pressione sul legamento plantare. <strong>La fascite non ha più carburante per farti male.</strong></> },
  { img: "/images/land/aureastep/card2.png", alt: "Stabilità ad Ogni Passo", chip: "Passo stabile · Più controllo", title: "Stabilità ad Ogni Passo", text: <>La suola accompagna il passo e protegge le ginocchia dal cedimento laterale. <strong>Meno instabilità, meno usura articolare.</strong></> },
  { img: "/images/land/aureastep/card3.png", alt: "Plantare Supportivo Estraibile", chip: "Supporto interno · Più comfort", title: "Plantare Supportivo Estraibile", text: <>Sostiene tallone, arco e avampiede. <strong>Funziona anche con il tuo plantare personalizzato.</strong></> },
  { img: "/images/land/aureastep/card4.png", alt: "Camera d'Aria Ammortizzante", chip: "Anti-impatto · Passo più morbido", title: "Camera d'Aria Ammortizzante", text: <>Assorbe l&apos;onda d&apos;urto prima che raggiunga ginocchio e anca. <strong>Ogni passo che fai non distrugge più le articolazioni.</strong></> },
  { img: "/images/land/aureastep/card5.png", alt: "Rialzo Biomeccanico", chip: "Lombare · Postura", title: "Rialzo Biomeccanico", text: <>Il cuneo posteriore riallinea il bacino ad ogni passo. <strong>La colonna smette di compensare. Il dolore lombare diminuisce.</strong></> },
  { img: "/images/land/aureastep/card6.png", alt: "Tomaia Morbida e Avvolgente", chip: "Comfort · Zero Attrito", title: "Tomaia Morbida e Avvolgente", text: <>Il materiale si adatta alla forma del tuo piede senza punti di pressione. <strong>Nessun attrito, nessun dolore. Perfetta anche per alluce valgo e piedi sensibili.</strong></> },
];
