    ...
    <div className="md:sticky md:top-24">
      ...
      <div className="relative aspect-square overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
        <img
          key={active}
          src={images[active]}
          alt={`OrthoStep Pro - Foto ${active + 1}`}
...
const lpReviewData = [
  { batch: 1, av: "M", name: "Marco G.", meta: "✓ Verificata · Napoli", stars: "★★★★★", text: "Lavoro 12 ore in piedi come cuoco. Prima tornavo a casa che non camminavo più dal dolore. Con le OrthoStep mi sento un ragazzino! Le ginocchia non scricchiolano più." },
  ...
  { batch: 1, av: "R", name: "Roberto F.", meta: "✓ Verificata · Milano", stars: "★★★★★", text: "Il dottore voleva operarmi alle ginocchia per l'artrosi. Dopo 1 mese con OrthoStep ho annullato l'operazione! Il dolore è quasi sparito." },
          ...
          <>
            ...
            <form onSubmit={(e) => { e.preventDefault(); setFormSubmitted(true); }}>
              ...
              <div className="lp-rev-field">
                ...
                <textarea id="lp-rv-text" placeholder="Raccontaci la tua esperienza con le OrthoStep..." required />
              </div>
...
const lpFaqData = [
  ...
  { q: "Come scelgo la taglia giusta?", a: "Le OrthoStep calzano regolare. Se sei tra due taglie, scegli quella più grande. Scrivici su WhatsApp dopo l'ordine se hai dubbi." },
  { q: "Funzionano davvero per il mal di schiena e ginocchia?", a: "Sì! La suola curva biomeccanica ridistribuisce il peso corporeo e assorbe gli impatti. Il 96% dei nostri clienti riporta una riduzione significativa del dolore già dalla prima settimana." },
  { q: "Posso usarle tutto il giorno?", a: "Assolutamente sì, sono progettate per uso quotidiano prolungato. Se non hai mai usato una suola curva, inizia gradualmente nei primi 2-3 giorni." },
  { q: "Posso restituirle se non mi piacciono?", a: "Hai 30 giorni dalla consegna. Scrivici con il tuo numero d'ordine. Rispondiamo entro 24 ore. Soddisfatto o rimborsato, senza domande." },
  { q: "Posso usare il mio plantare personalizzato?", a: "Sì, la soletta è estraibile. Puoi sostituire il plantare incluso con il tuo plantare personalizzato senza problemi." },
];
