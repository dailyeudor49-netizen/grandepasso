...
function getCarouselImages(): string[] {
  ...
  return fs
    ...
    .map((f) => `/images/land/orthostep/carosello/${f}`);
}

export const metadata: Metadata = {
  title: "OrthoStep Pro - Scarpe Ortopediche per il Benessere dei Tuoi Piedi",
  description:
      ...
      <div className="grid items-start gap-8 md:grid-cols-2 md:gap-12">
        ...
        <div>
          ...
          <h1 className="mb-1 text-2xl font-extrabold tracking-tight text-gray-900 md:text-3xl">
            <span className="text-blue-700">OrthoStep Pro</span> — Scarpe ortopediche anti-dolore
          </h1>
          <p className="mb-4 text-base font-medium text-gray-500">
            Con suola curva biomeccanica che elimina il dolore: proteggi piedi, ginocchia e schiena ad ogni passo.
          </p>
          ...
          <ul className="mb-6 space-y-2.5">
            {[
              { bold: "Elimina il dolore ai piedi", rest: "sollievo immediato dal primo giorno" },
              { bold: "Protegge ginocchia e schiena", rest: "la suola curva assorbe ogni impatto" },
              { bold: "Supporto arco plantare", rest: "ideale per piede piatto e fascite plantare" },
              { bold: "Postura corretta", rest: "allinea la colonna vertebrale naturalmente" },
              { bold: "Ammortizzazione premium", rest: "cammina ore senza stancarti" },
              { bold: "Traspirante e leggera", rest: "piedi freschi e asciutti tutto il giorno" },
              { bold: "Calze comfort incluse", rest: "a compressione graduata (valore €14,90)" },
            ].map((f) => (
...
export default function OrthoStepLanding() {
  return (
  ...
  return (
    <section className="lp-fasi">
      <div className="lp-fasi-head">
        <h2>Cammini e il Dolore <em>Scompare</em></h2>
        <p>OrthoStep Pro non è una scarpa qualunque. È un sistema biomeccanico che assorbe gli impatti, protegge le articolazioni e corregge la postura ad ogni passo.</p>
      </div>
      <div className="lp-fasi-grid">
        {[
          { img: "/images/land/orthostep/ammortizzazione.webp", alt: "Ammortizzazione", tag: "Beneficio 1", title: "Assorbe gli Impatti", text: "La suola curva ammortizza ogni passo. Piedi, ginocchia e schiena non subiscono più colpi." },
          { img: "/images/land/orthostep/piede-piatto.webp", alt: "Supporto Arco", tag: "Beneficio 2", title: "Supporta l'Arco", text: "Il plantare solleva e sostiene l'arco del piede. Ideale per piede piatto e fascite plantare." },
          { img: "/images/land/orthostep/carosello/scaricapressione.png", alt: "Zero Dolore", tag: "Beneficio 3", title: "Zero Dolore", text: "In pochi giorni senti la differenza. Cammini per ore senza dolore, torni a vivere." },
        ].map((f) => (
...
const techCards = [
  { img: "/images/land/orthostep/card1.png", alt: "Scarica la pressione", chip: "Meno carico • Più sollievo", title: "Scarica la pressione", text: "Aiuta a distribuire meglio il carico sotto il piede durante la camminata." },
  { img: "/images/land/orthostep/card2.png", alt: "Più stabilità a ogni passo", chip: "Passo stabile • Più controllo", title: "Più stabilità a ogni passo", text: "La struttura della suola accompagna il passo e aumenta la sensazione di stabilità." },
  { img: "/images/land/orthostep/card3.png", alt: "Plantare supportivo estraibile", chip: "Supporto interno • Più comfort", title: "Plantare supportivo estraibile", text: "Il plantare estraibile sostiene tallone, arco e avampiede per un comfort più completo." },
  { img: "/images/land/orthostep/card4.png", alt: "Ammortizza ogni passo", chip: "Anti-impatto • Passo più morbido", title: "Ammortizza ogni passo", text: "L'ammortizzazione aiuta ad assorbire meglio l'impatto e a rendere il passo più confortevole." },
  { img: "/images/land/orthostep/card5.png", alt: "Passo più guidato", chip: "Rullata fluida • Movimento naturale", title: "Passo più guidato", text: "La forma della suola favorisce una transizione più accompagnata dal tallone alla punta." },
  { img: "/images/land/orthostep/card6.png", alt: "Zip laterale, calzata facile", chip: "Più pratica • Ogni giorno", title: "Zip laterale, calzata facile", text: "La zip laterale rende la calzata più semplice e veloce, senza rinunciare al supporto." },
];
  ...
  return (
    <section className="lp-sec">
      <div className="lp-inner">
        ...
        <p className="sub">Ogni dettaglio della OrthoStep è progettato per eliminare il dolore e farti camminare meglio.</p>
...
function TimelineSection() {
  return (
    <section className="lp-sec lp-sec-light" style={{ background: "#f0fdf4" }}>
      <div className="lp-inner">
        <h2>Dolore Eliminato in <em>4 Settimane</em></h2>
        <p className="sub">Anche solo camminare normalmente con OrthoStep basta per sentire la differenza.</p>
        <div className="lp-timeline">
          {[
            { week: "Settimana 1", pct: "25%", title: "Ti abitui alla suola curva", text: "Il piede si adatta alla nuova postura. Senti già meno dolore ai piedi e alle ginocchia." },
            { week: "Settimana 2", pct: "50%", title: "Il dolore diminuisce", text: "Schiena e ginocchia ringraziano. Cammini più a lungo senza fatica. La postura migliora." },
            { week: "Settimana 3", pct: "75%", title: "Torni a vivere", text: "Riesci a fare cose che avevi smesso di fare. Passeggiate, shopping, giocare coi nipoti." },
            { week: "Settimana 4", pct: "100%", title: "Dolore sparito", text: "Il cambiamento è completo. Cammini senza pensare al dolore. Ti senti ringiovanito." },
          ].map((s) => (
